...
elseif(MSVC)
  if((CMAKE_GENERATOR_PLATFORM MATCHES "ARM64") OR (CMAKE_GENERATOR MATCHES "ARM64") OR ("${arch_hint}" STREQUAL "ARM64") OR (CMAKE_VS_EFFECTIVE_PLATFORMS MATCHES "ARM64|arm64"))
    set(OpenCV_ARCH AARCH64)
  elseif((CMAKE_GENERATOR_PLATFORM MATCHES "ARM") OR (CMAKE_GENERATOR_PLATFORM MATCHES "ARM") OR ("${arch_hint}" STREQUAL "ARM") OR (CMAKE_VS_EFFECTIVE_PLATFORMS MATCHES "ARM|arm"))
    set(OpenCV_ARCH ARM)
  elseif(CMAKE_CL_64)
    set(OpenCV_ARCH x64)
  else()
  ...
  message(STATUS "OpenCV_ARCH is ${OpenCV_ARCH}")
